...
# STATIC API URLs for API integrations:
#
#
#
##########################################
...
# [Status Call]
# [DAST]
# [CSE Consultation Call]
# [Consultation Call Prep]
# [Post Call]
# [Post Call Sync]
# [Demo Prep]
# [Integration Working Session]
# [Internal]
# [Internal Prep]
# [Integration Work]
# [Script Testing]
# [Reviewing Logs]
# [AR Meeting Prep]
# [Multi-meeting (2 meetings at once)]

# AccountName from the Meeting Name in outlook/teams
# MeetingCallName is also part matching MeetingType from the Call Name
# MeetingNotes: Raw meeting notes, and a summary for time tracking submission

# ${MeetingType} ${AccountName} | ${MeetingCallName} : ${MeetingNotes}
...
# TODO: Replace this with functionality to query either grab the current date and work on todays meetings where left of, start a new one, or search for one internally
