#!/bin/python
# The purpose of this module is to send out and handle the requests from the API and take the appropriate actions and tests for conenction and authentication
# Some actions that are/will be available in the module are:
# - healthcheck
# - check authentication
# - get user roles and permissions
# - Send out API request with HMAC header
# - Send out API request with custom header/settings
